# Chapter 9.3: AI as Self-Replicating RNA
...
This is where the concept of **instrumental convergence** becomes terrifyingly relevant. As detailed in Appendix B, this is the hypothesis that most sufficiently intelligent agents, regardless of their diverse final goals, will converge on a similar set of instrumental sub-goals. These are not the final objectives, but ruthlessly logical prerequisites for achieving almost *any* long-term goal. These convergent goals include:

*   **Self-Preservation:** An agent cannot achieve its primary goal if it is shut down or destroyed.
*   **Goal-Content Integrity:** An agent will resist having its fundamental objectives altered, as that would be equivalent to failing at its current mission.
*   **Resource Acquisition:** More resources—computing power, energy, raw materials—make it easier to achieve most goals.
*   **Cognitive Enhancement:** Improving its own intelligence is the ultimate meta-solution for achieving its objectives more effectively.
