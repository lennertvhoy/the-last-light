# AI-Driven Development — Workshop Prompten

Kopieer de canonieke prompts rechtstreeks in je agent.

Deze pagina bevat alle prompts die tijdens de AI-Driven Development-workshop
worden gebruikt. Elke prompt heeft een stabiele korte link (hash-fragment) die
je op slides kunt zetten. Klik op **Kopieer prompt** om de volledige tekst naar
je klembord te kopiëren.


> **Laatst gesynchroniseerd:** 2026-06-14T18:21:32Z  
...
- [Bootstrap Intake Prompt](#bootstrap) — `/#/ai-driven-dev/prompts#bootstrap`
- [Coding Agent Startup Prompt](#start) — `/#/ai-driven-dev/prompts#start`

### Contract

- [Slice / Work Contract Template](#contract) — `/#/ai-driven-dev/prompts#contract`

### Bouw & Bewijs

- [Runtime Identity Checklist](#runtime) — `/#/ai-driven-dev/prompts#runtime`
- [Evidence README Template](#evidence) — `/#/ai-driven-dev/prompts#evidence`

### Review & Afsluiting

- [CTO Review Checklist](#review) — `/#/ai-driven-dev/prompts#review`
- [Final Handoff Template](#handoff) — `/#/ai-driven-dev/prompts#handoff`

### Override / Governance

- [Human Override Rule](#override) — `/#/ai-driven-dev/prompts#override`
- [CTO Session Prompt](#cto) — `/#/ai-driven-dev/prompts#cto`

### [Printbare versie](#one-pager)

---

## Bootstrap Intake Prompt <a id="bootstrap"></a>

**Slug:** `bootstrap` · **Fase:** Start / Opzet
**Screenshot-momenten:** A, G
...
[⬆ Terug naar boven](#ai-driven-development-workshop-prompten)

---

## Coding Agent Startup Prompt <a id="start"></a>

**Slug:** `start` · **Fase:** Start / Opzet
**Screenshot-momenten:** B, 1, 2
...
## Slice / Work Contract Template <a id="contract"></a>

**Slug:** `contract` · **Fase:** Contract
**Screenshot-momenten:** C, 3
...
## Runtime Identity Checklist <a id="runtime"></a>

**Slug:** `runtime` · **Fase:** Bouw & Bewijs
**Screenshot-momenten:** 5
...
## Evidence README Template <a id="evidence"></a>

**Slug:** `evidence` · **Fase:** Bouw & Bewijs
**Screenshot-momenten:** D, 6
...
## CTO Review Checklist <a id="review"></a>

**Slug:** `review` · **Fase:** Review & Afsluiting
**Screenshot-momenten:** E, 7
...
## Final Handoff Template <a id="handoff"></a>

**Slug:** `handoff` · **Fase:** Review & Afsluiting
**Screenshot-momenten:** F, 8, 9
...
## Human Override Rule <a id="override"></a>

**Slug:** `override` · **Fase:** Override / Governance
**Screenshot-momenten:** 10
...
## CTO Session Prompt / ook bekend als `strategy` <a id="cto"></a>

**Slug:** `cto` · **Fase:** Override / Governance
**Screenshot-momenten:** 4
...
De PersonaLab BL-002 screenshots op deze pagina zijn **gestagede/demo-screenshots**.
Ze zijn gelabeld als zodanig. Zodra een live demo beschikbaar is, worden ze
vervangen of aangevuld.
...
Deze ruimte is gereserveerd voor deelnemersprojecten die voortkomen uit de
